...
class MatchesTest < ApplicationSystemTestCase
  ...
  test "creating a Match" do
    ...
    fill_in "Average score", with: @match.average_score
    fill_in "Matchcost", with: @match.matchcost
    fill_in "Mp link", with: @match.mp_link
    fill_in "Warmup", with: @match.warmup
